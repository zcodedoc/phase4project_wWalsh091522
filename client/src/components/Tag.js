    ...
    return (
          <div style={{display: 'flex', flexDirection: 'column'}}>
              <div style={{border: '0px solid black', overflow: 'scroll', padding: '0px', maxWidth: '80%', marginLeft: '10%', display: 'flex', flexDirection: 'row', maxHeight: '100%'}}>
                {tags.length > 0 ? (
                  tags.map((tag) => (
                  <div key={tag.id} style={{marginLeft: '10px', height: '100px', maxWidth: '70%',  marginLeft: '5%', backgroundColor: "white", padding: '0px', height: '300px', border: '0px solid black', marginBottom: '50px'}}>
